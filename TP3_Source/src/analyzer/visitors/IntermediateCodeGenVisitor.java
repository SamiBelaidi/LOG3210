...
public class IntermediateCodeGenVisitor implements ParserVisitor {
    ...
    public Object visit(ASTIfStmt node, Object data) {
        ...
        if (node.jjtGetNumChildren() == 2) {
            BoolLabel b = new BoolLabel(genLabel(), data.toString());
    ...
    public Object visit(ASTWhileStmt node, Object data) {
        ...
        BoolLabel boolData = new BoolLabel(genLabel(), data.toString());
        m_writer.println(lBegin);
        node.jjtGetChild(0).jjtAccept(this, boolData);
        m_writer.println(boolData.lTrue);
    ...
    public Object visit(ASTBoolExpr node, Object data) {
        if (node.jjtGetNumChildren() == 1) {
            ...
            if (node.getOps().get(0).equals("&&")) {
                BoolLabel b1 = new BoolLabel(genLabel(), ((BoolLabel) data).lFalse);
                ...
                BoolLabel b1 = new BoolLabel(((BoolLabel) data).lTrue, genLabel());
                BoolLabel b2 = new BoolLabel(((BoolLabel) data).lTrue, ((BoolLabel) data).lFalse);
                node.jjtGetChild(0).jjtAccept(this, b1);
...
//        return null;
    ...
    public Object visit(ASTBoolValue node, Object data) {
        ...
        m_writer.println("goto " + (node.getValue() ? tmpData.lTrue : tmpData.lFalse));
